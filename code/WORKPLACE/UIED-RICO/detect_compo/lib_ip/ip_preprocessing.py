...
def preprocess(org, grad_min=C.THRESHOLD_PRE_GRADIENT, morph_peremeter=C.THRESHOLD_PRE_MORPH, write_path=None):
    ...
    morph = cv2.morphologyEx(binary, cv2.MORPH_CLOSE, morph_peremeter)   # remove noises

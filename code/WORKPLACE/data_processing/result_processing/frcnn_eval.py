...
def eval(detection, ground_truth, img_root, show=True, no_text=True, only_text=False):
    def compo_filter(compos):
    ...
    for i, image_id in enumerate(detection):
        ...
        # d_compos = compo_filter(d_compos)
        gt_compos = compo_filter(gt_compos)
...
frcnn = parse_results('E:\Mulong\Result\\rico\\centernet.json', 0.28)
gt = load_ground_truth_json('E:\\Mulong\\Datasets\\rico\\instances_test.json')
eval(frcnn, gt, img_root='E:\\Mulong\\Datasets\\rico\\combined', show=False)

...
corners_text = det.text_detection(binary, boundary_all)
corners_all = det.get_corner(boundary_all)
...
draw_bounding = draw.draw_bounding_box(corners_text, draw_bounding, (190, 190, 255), 1)

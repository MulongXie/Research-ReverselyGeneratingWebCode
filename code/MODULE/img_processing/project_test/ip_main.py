...
irregular_img_corners = det.is_irregular_img(det.get_corner(boundary_non_rec), 25, 25, 600, 600, 2.5)
text_corners = det.is_text(det.get_corner(boundary_non_rec), 100, 2)
...
bounding_drawn = draw.draw_bounding_box(text_corners, bounding_drawn, (255, 255, 0), 1)

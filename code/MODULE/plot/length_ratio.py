...
paths = glob.glob(pjoin(root_button, '*'))
...
p = plt.figure(1)
ax = plt.subplot(311)
ax.set_title('Shape of Button')
ax.set_xlabel('Height')
ax.set_ylabel('Number')
plt.grid(axis='y', ls='--')
plt.hist(heights, bins=50, color='#99CCFF', range=(0,120))

ax = plt.subplot(312)
ax.set_xlabel('Width')
ax.set_ylabel('Number')
plt.grid(axis='y', ls='--')
plt.hist(widths, bins=50, color='#FFCC33', range=(0,700))

ax = plt.subplot(313)
ax.set_xlabel('Width / Height')
ax.set_ylabel('Number')
plt.grid(axis='y', ls='--')
plt.hist(ratios, bins=50, color='#0099CC', range=(0,12))
